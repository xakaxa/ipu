...
masscan -Pn -sS -iL list.txt  --rate 30000  -p --open-only --excludefile block.txt --output-format list --output-file list.txt
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
443,1443,2443,3443,4443,4445,5443,6443,7443,8443,9443,
10443,11443,12443,13443,14443,15443,16443,17443,18443,19443,
20443,21443,22443,23443,24443,25443,26443,27443,28443,29443,
30443,32443,32443,33443,34443,35443,36443,37443,38443,39443,
40443,41443,42443,43443,44343,45443,46443,47443,48443,49443,
50443,51443,52443,53443,54343,55443,56443,57443,58443,59443,
60443,61443,62443,63443,64443,65443
0-65535
...
for i in $(seq 1 10); do
  echo "nuclei -rl 0 -bs 1000 -l target/from_bot/from_bot_$i -t in_dis/n/ -o ${i}.out --stats && rm target/from_bot/from_bot_$i"
done
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
nuclei -rl 500 -bs 100 -timeout 5 -t you_template.yaml -o good.txt
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
